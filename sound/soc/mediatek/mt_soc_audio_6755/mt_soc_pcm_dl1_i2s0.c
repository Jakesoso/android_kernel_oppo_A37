...
int mi2s0_hdoutput_control;
int mi2s0_fm_hdoutput_control;
int mi2s0_voice_hdoutput_control;
#else
...
//yuanyan@Multimedia, 2016/06/28, Add for speaker noise
#if defined(OPPO_MTK_15131_PROJECT)
static int Audio_i2s0_fm_hdoutput_Get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	PRINTK_AUD_DL1("Audio_i2s0_hdoutput_Get = %d\n", mi2s0_fm_hdoutput_control);
	ucontrol->value.integer.value[0] = mi2s0_fm_hdoutput_control;
	return 0;
}

static int Audio_i2s0_fm_hdoutput_Set(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	PRINTK_AUD_DL1("+%s()\n", __func__);
	if (ucontrol->value.enumerated.item[0] > ARRAY_SIZE(i2s0_HD_output)) {
	...
	mi2s0_fm_hdoutput_control = ucontrol->value.integer.value[0];

	PRINTK_AUD_DL1("-%s(), mi2s0_hdoutput_control=%d\n", __func__, mi2s0_fm_hdoutput_control);
	return 0;
}

static int Audio_i2s0_voice_hdoutput_Get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	PRINTK_AUD_DL1("Audio_i2s0_hdoutput_Get = %d\n", mi2s0_voice_hdoutput_control);
	ucontrol->value.integer.value[0] = mi2s0_voice_hdoutput_control;
	return 0;
}

static int Audio_i2s0_voice_hdoutput_Set(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	PRINTK_AUD_DL1("+%s()\n", __func__);
	if (ucontrol->value.enumerated.item[0] > ARRAY_SIZE(i2s0_HD_output)) {
	...
	mi2s0_voice_hdoutput_control = ucontrol->value.integer.value[0];

	PRINTK_AUD_DL1("-%s(), mi2s0_hdoutput_control=%d\n", __func__, mi2s0_voice_hdoutput_control);
	return 0;
}
#endif
...
//yuanyan@Multimedia, 2016/06/28, Add for speaker noise
#if defined(OPPO_MTK_15131_PROJECT)
	SOC_ENUM_EXT("Audio_i2s0_fm_hd_Switch",
	Audio_i2s0_Enum[1], Audio_i2s0_fm_hdoutput_Get, Audio_i2s0_fm_hdoutput_Set),
	SOC_ENUM_EXT("Audio_i2s0_voice_hd_Switch",
	Audio_i2s0_Enum[1], Audio_i2s0_voice_hdoutput_Get, Audio_i2s0_voice_hdoutput_Set),
#endif
