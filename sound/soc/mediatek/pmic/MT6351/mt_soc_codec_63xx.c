...
/*yongzhi.zhang@Multimedia, 2016/01/15, Add for MT6755*/
uint32 mBlockSampleRate[AUDIO_ANALOG_DEVICE_INOUT_MAX] = { 48000, 48000, 48000 };
#else
static uint32 mBlockSampleRate[AUDIO_ANALOG_DEVICE_INOUT_MAX] = { 48000, 48000, 48000 };
/*yongzhi.zhang@Multimedia, 2016/01/15, Add for MT6755 End*/
#endif
...
/* yongzhi.zhang@Multimedia, 2015/12/18, block GPIO24 actions to avoid current issue and other side effect */
...
/* yongzhi.zhang@Multimedia, 2015/12/18, block GPIO24 actions to avoid current issue and other side effect end */
#else
