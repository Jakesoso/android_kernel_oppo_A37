...
#define FTS_DRIVER_LIB_INFO  "Test_Lib_Version  V1.4.1 2015-12-03"
...
boolean start_test_tp(void) 
{
	...
	printk("start_test_tp:: %s \n", FTS_DRIVER_LIB_INFO);	//show lib version
	printk("start_test_tp:: %s start \n", __func__);
	printk("start_test_tp::IC_%s Test\n", g_strIcName);
	printk("start_test_tp::iSelectedIC::0x%x\n",g_ScreenSetParam.iSelectedIC>>4);
	printk("start_test_tp::IC_FT8606::0x%x\n",IC_FT8606>>4);
	printk("start_test_tp::IC_FT5X46::0x%x\n",IC_FT5X46>>4);
	printk("start_test_tp::IC_FT5822::0x%x\n",IC_FT5822>>4);
	printk("start_test_tp::IC_FT6X36::0x%x\n",IC_FT6X36>>4);
	printk("start_test_tp::IC_FT3C47U::0x%x\n",IC_FT3C47U>>4);
