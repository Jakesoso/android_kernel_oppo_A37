...
int get_dlpt_imix(void)
{
	...
	pr_debug("[get_dlpt_imix after ptim]MT6351_AUXADC_IMP0 0x%x:0x%x, MT6353_AUXADC_CON2 0x%x:0x%x, MT6353_AUXADC_LBAT1 0x%x:0x%x\n",
...
#if 0 /* argus TBD */
	debugfs_create_file("low_battery_protect_ut", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &low_battery_protect_ut_fops);
	debugfs_create_file("low_battery_protect_stop", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &low_battery_protect_stop_fops);
	debugfs_create_file("low_battery_protect_level", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &low_battery_protect_level_fops);
	debugfs_create_file("battery_oc_protect_ut", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_oc_protect_ut_fops);
	debugfs_create_file("battery_oc_protect_stop", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_oc_protect_stop_fops);
	debugfs_create_file("battery_oc_protect_level", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_oc_protect_level_fops);
	debugfs_create_file("battery_percent_protect_ut", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_percent_protect_ut_fops);
	debugfs_create_file("battery_percent_protect_stop", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_percent_protect_stop_fops);
	debugfs_create_file("battery_percent_protect_level", S_IRUGO | S_IWUSR, mt_pmic_dir, NULL, &battery_percent_protect_level_fops);
