...
static unsigned int vcore2_use_count = 0;
...
void pmic_buck_vproc_sw_en(int en_value)
{
	...
	pr_debug("buck : VPROC ; sw enable = %d\n", en_value);
	...
	pr_debug("buck : VPROC ; sw en_value readback = %d\n", read_back);
}
...
void pmic_buck_vproc_hw_en(int ensel_value)
{
	...
	pr_debug("buck : VPROC ; hw en_sel = %d\n", ensel_value);
	...
	pr_debug("buck : VPROC ; hw en_sel readback = %d\n", read_back);
}
...
void pmic_buck_vs1_sw_en(int en_value)
{
	...
	pr_debug("buck : VS1   ; sw en_value readback = %d\n", read_back);
}
...
void pmic_buck_vs1_hw_en(int ensel_value)
{
	...
	pr_debug("buck : VS1   ; hw en_sel readback = %d\n", read_back);
}
...
void pmic_buck_vcore_sw_en(int en_value)
{
	...
	pr_debug("buck : VCORE ; sw enable = %d\n", en_value);
	...
	pr_debug("buck : VCORE ; sw en_value readback = %d\n", read_back);
}
...
void pmic_buck_vcore_hw_en(int ensel_value)
{
	...
	pr_debug("buck : VCORE ; hw en_sel = %d\n", ensel_value);
	...
	pr_debug("buck : VCORE ; hw en_sel readback = %d\n", read_back);
}
...
void pmic_buck_vcore2_sw_en(int en_value)
{
	...
	pr_debug("buck : VCORE2; sw enable = %d\n", en_value);
	...
	pr_debug("buck : VCORE2; sw en_value readback = %d\n", read_back);
}
...
void pmic_buck_vcore2_hw_en(int ensel_value)
{
	...
	pr_debug("buck : VCORE2; hw en_sel = %d\n", ensel_value);
	...
	pr_debug("buck : VCORE2; hw en_sel readback = %d\n", read_back);
}
...
void pmic_ldo_vsram_proc_sw_en(int en_value)
{
	...
	pr_debug("buck : VSRAM_PROC; sw enable = %d\n", en_value);
	...
	pr_debug("buck : VSRAM_PROC; sw en_value readback = %d\n", read_back);
}
...
void pmic_ldo_vsram_proc_hw_en(int ensel_value)
{
	...
	pr_debug("buck : VSRAM_PROC; hw en_sel = %d\n", ensel_value);
	...
	pr_debug("buck : VSRAM_PROC; hw en_sel readback = %d\n", read_back);
}
