...
/* these definitions should already be done in mt_gpufreq.h */
...
void ged_dvfs_probe_signal(int signo)
{
    ...
    {
        pid_query = find_get_pid(g_probe_pid);
        t = get_pid_task(pid_query, PIDTYPE_PID);
    }
