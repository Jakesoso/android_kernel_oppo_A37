...
#define TYPE_C_INTR_EN_0_MSK (TYPE_C_INTR_EN_0_ATTACH_MSK | \
	...
	REG_TYPE_C_CC_ENT_ATTACH_WAIT_SNK_INTR_EN | REG_TYPE_C_CC_ENT_TRY_SRC_INTR_EN | REG_TYPE_C_CC_ENT_TRY_WAIT_SNK_INTR_EN | \
...
#define TYPE_C_INTR_EN_2_MSK (REG_TYPE_C_CC_ENT_SNK_PWR_IDLE_INTR_EN | REG_TYPE_C_CC_ENT_SNK_PWR_DEFAULT_INTR_EN | \
	REG_TYPE_C_CC_ENT_SNK_PWR_15_INTR_EN | REG_TYPE_C_CC_ENT_SNK_PWR_30_INTR_EN | REG_TYPE_C_CC_ENT_SNK_PWR_REDETECT_INTR_EN)
...
#define TYPEC_TERM_CC1 (REG_TYPE_C_SW_FORCE_MODE_DA_CC_RPCC1_EN | REG_TYPE_C_SW_FORCE_MODE_DA_CC_RDCC1_EN | REG_TYPE_C_SW_FORCE_MODE_DA_CC_RACC1_EN)
#define TYPEC_TERM_CC2 (REG_TYPE_C_SW_FORCE_MODE_DA_CC_RPCC2_EN | REG_TYPE_C_SW_FORCE_MODE_DA_CC_RDCC2_EN | REG_TYPE_C_SW_FORCE_MODE_DA_CC_RACC2_EN)
...
static void typec_writew_msk(struct typec_hba *hba, uint16_t msk, uint16_t val, unsigned int reg)
{
	uint16_t tmp;
...
static void typec_set(struct typec_hba *hba, uint16_t val, unsigned int reg)
{
	uint16_t tmp;
...
static void typec_clear(struct typec_hba *hba, uint16_t val, unsigned int reg)
{
	uint16_t tmp;
...
#if DBG_PROBE
static void typec_sw_probe(struct typec_hba *hba, uint32_t msk, uint32_t val)
{
