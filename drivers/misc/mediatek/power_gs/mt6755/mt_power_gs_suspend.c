...
void mt_power_gs_dump_suspend(void)
{
    ...
    mt_power_gs_compare("Suspend",                                \
			MT6353_PMIC_REG_gs_flightmode_suspend_mode, MT6353_PMIC_REG_gs_flightmode_suspend_mode_len);
#else
    mt_power_gs_compare("Suspend",                                \
			MT6351_PMIC_REG_gs_flightmode_suspend_mode, MT6351_PMIC_REG_gs_flightmode_suspend_mode_len);
#endif
