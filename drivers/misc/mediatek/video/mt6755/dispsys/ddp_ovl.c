...
#ifdef VENDOR_EDIT
/* liping-m@PhoneSW.Multimedia, 2016/02/04 MTK CR ALPS02357137 and ALPS02564311 */
	/* ASSERT(0); */
#endif
		return -1;
	}
...
void ovl_dump_reg(DISP_MODULE_ENUM module)
{
	...
	DDPDUMP("OVL:0x1d4=0x%08x,0x1f8=0x%08x,0x1fc=0x%08x,0x200=0x%08x,0x20c=0x%08x\n"
		...
		"0x230=0x%08x,0x234=0x%08x,0x240=0x%08x,0x244=0x%08x,0x24c=0x%08x,0x250=0x%08x,0x254=0x%08x,0x258=0x%08x,0x2A0=0x%08x,0x2A4=0x%08x\n",
