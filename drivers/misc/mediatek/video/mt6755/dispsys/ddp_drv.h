...
#define DISP_IOCTL_SET_GAMMALUT_OFF       _IOW    (DISP_IOCTL_MAGIC, 103, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_GET_GAMMALUT_OFF       _IOR    (DISP_IOCTL_MAGIC, 104, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_SET_GAMMALUT_LEVEL1    _IOW    (DISP_IOCTL_MAGIC, 105, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_GET_GAMMALUT_LEVEL1    _IOR    (DISP_IOCTL_MAGIC, 106, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_SET_GAMMALUT_LEVEL2    _IOW    (DISP_IOCTL_MAGIC, 107, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_GET_GAMMALUT_LEVEL2    _IOR    (DISP_IOCTL_MAGIC, 108, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_SET_GAMMALUT_LEVEL3    _IOW    (DISP_IOCTL_MAGIC, 109, DISP_GAMMA_LUT_T)
#define DISP_IOCTL_GET_GAMMALUT_LEVEL3    _IOR    (DISP_IOCTL_MAGIC, 110, DISP_GAMMA_LUT_T)
//#endif /*VENDOR_EDIT*/
