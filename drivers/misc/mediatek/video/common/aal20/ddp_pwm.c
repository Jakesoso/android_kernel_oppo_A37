...
#ifdef VENDOR_EDIT
/* liping-m@PhoneSW.Multimedia, 2014/10/22  Add for backlight controled by AAL service */
#ifdef R63417_FHD_DSI_VDO_JDI
extern int lm3630a_setbacklight(unsigned int level);
#endif

#ifdef S6E3FA3_FHD_DSI_CMD
extern int lcm_set_backlight(unsigned int level);
#endif

/* liuyan@Onlinerd.driver, 2014/12/08  Add for oled panel set backlight */
#ifdef S6E3FA2_FHD1080_DSI_VDO
extern void lcm_set_backlight(unsigned int level);
#endif
#endif /*VENDOR_EDIT*/
...
int disp_pwm_set_backlight_cmdq(disp_pwm_id_t id, int level_1024, void *cmdq)
{
	...
	/* liping-m@PhoneSW.Multimedia, 2014/10/22  Add for backlight controled by AAL service */
    #ifdef R63417_FHD_DSI_VDO_JDI
				printk("%s level_1024 is %d\n", __func__, level_1024);
				lm3630a_setbacklight(level_1024 / 4);
	#endif
    #ifdef S6E3FA3_FHD_DSI_CMD
				printk("%s level_1024 is %d\n", __func__, level_1024);
				lcm_set_backlight(level_1024/4);
    #endif

	/* liuyan@Onlinerd.driver, 2014/12/08  Add for set backlight */
    #ifdef S6E3FA2_FHD1080_DSI_VDO
			 lcm_set_backlight(level_1024/4);
     #endif
#endif /*VENDOR_EDIT*/
