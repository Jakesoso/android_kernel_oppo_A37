...
//#define EINT6                      6
//#define FPC1020_INT_IRQNO       EINT6
#define FPC1020_INT_IRQNO       CUST_EINT_FPC_NUM
#define FPC1020_SPI_CLOCK_SPEED                 (5 * 1000000U)

#define FPC_DEBUG  mdelay(10);printk("%s\n", __func__)
#define FUNC_IN  printk("--> %s\n", __func__)
#define FUNC_OUT  printk("<-- %s\n", __func__)
#define FPC1020_IRQ_GPIO        GPIO_FPC_EINT_PIN
#define FPC1020_RESET_GPIO      GPIO_FPC_RESET_PIN
#define FPC1020_CS_GPIO         GPIO_FPC_CS_PIN

#define FPC1020_SPI_CS        GPIO_SPI_CS_PIN
#define FPC1020_SPI_MOSI      GPIO_SPI_MOSI_PIN
#define FPC1020_SPI_MISO      GPIO_SPI_MISO_PIN
#define FPC1020_SPI_SCK       GPIO_SPI_SCK_PIN
