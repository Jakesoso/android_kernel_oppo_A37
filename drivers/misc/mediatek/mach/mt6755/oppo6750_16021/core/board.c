...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
	...
	.clk_src              = MSDC1_CLKSRC_DEFAULT,
        ...
        .wdata_edge           = MSDC_SMPL_FALLING,
        .clk_drv              = 3,
//#ifndef VENDOR_EDIT//Fanhong.Kong@ProDrv.CHG,modified 2015.12.22 for sdcard		
//		.cmd_drv			  = 3,
//#else/*VENDOR_EDIT*/	
		.cmd_drv			  = 4,
//#endif/*VENDOR_EDIT*/
        .dat_drv              = 3,		
//#ifndef VENDOR_EDIT//Tong.han@Bsp.Tp,modified 2016.06.29 for some sdcard CRC error。		
//		 .clk_drv_sd_18        = 3,         /* sdr104 mode */
//#else
        .clk_drv_sd_18        = 7,         /* sdr104 mode */
//#endif/*VENDOR_EDIT*/
        .cmd_drv_sd_18        = 2,
        .dat_drv_sd_18        = 2,
	...
	.flags = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_UHS1 | MSDC_DDR,
        ...
        .host_function        = MSDC_SD,
        .boot	                = 0,
//#ifndef VENDOR_EDIT//Fanhong.Kong@ProDrv.CHG,modified 2015.9.30 for SD		
//        .cd_level             = MSDC_CD_LOW,
//#else/*VENDOR_EDIT*/	
