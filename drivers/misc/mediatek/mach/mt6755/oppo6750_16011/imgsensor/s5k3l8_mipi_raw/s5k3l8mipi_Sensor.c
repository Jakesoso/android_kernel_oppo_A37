...
extern CAMERA_BACK_DEV camera_back_dev;
#endif
...
//iAudi modify for slow shutter
    if(shutter>65520){
		...
		if(shutter > 65520&&shutter < 131100){
			...
			write_cmos_sensor(0x303E, 0x0C03);
			write_cmos_sensor(0x3046, 0x0020);
			write_cmos_sensor(0x3048, 0x0CB2);
			write_cmos_sensor(0x304A, 0x0100);
		    ...
		    write_cmos_sensor(0x31E4, 0x0058);
			write_cmos_sensor(0x0104, 0x0100);
			//write_cmos_sensor(0x0340, 0x1816);
			write_cmos_sensor(0x0342, 0x3F86);
			write_cmos_sensor(0x0200, 0x00C6);
			//write_cmos_sensor(0x0202, 0x1806);
			write_cmos_sensor(0x316A, 0x0000);
			write_cmos_sensor(0x303E, 0x1806);
			write_cmos_sensor(0x3046, 0x0020);
			write_cmos_sensor(0x3048, 0x1816);
			write_cmos_sensor(0x304A, 0x0100);
			write_cmos_sensor(0x0104, 0x0000);
			write_cmos_sensor(0x0100, 0x0100);
		}
			...
			write_cmos_sensor(0x316A, 0x0000);
			write_cmos_sensor(0x303E, 0x300C);
			write_cmos_sensor(0x3046, 0x0020);
			write_cmos_sensor(0x3048, 0x301C);
			write_cmos_sensor(0x304A, 0x0100);
		    write_cmos_sensor(0x0104, 0x0000);
			write_cmos_sensor(0x0100, 0x0100);
		}
			...
			write_cmos_sensor(0x316A, 0x0000);
			write_cmos_sensor(0x303E, 0x6016);
			write_cmos_sensor(0x3046, 0x0020);
			write_cmos_sensor(0x3048, 0x6026);
			write_cmos_sensor(0x304A, 0x0100);
			write_cmos_sensor(0x0104, 0x0000);
			write_cmos_sensor(0x0100, 0x0100);
		}
			...
			write_cmos_sensor(0x316A, 0x0000);
			write_cmos_sensor(0x303E, 0xC02B);
			write_cmos_sensor(0x3046, 0x0020);
			write_cmos_sensor(0x3048, 0xC03B);
			write_cmos_sensor(0x304A, 0x0100);
			write_cmos_sensor(0x0104, 0x0000);
			write_cmos_sensor(0x0100, 0x0100);
		}
...
#ifdef VENDOR_EDIT
/*oppo hufeng 20150515 add for device list*/
            camera_back_dev = CAMERA_BACK_S5K3L8;
#endif
