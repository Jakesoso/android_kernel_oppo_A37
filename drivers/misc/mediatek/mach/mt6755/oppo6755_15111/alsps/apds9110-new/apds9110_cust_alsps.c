...
static struct ps_adjust_para cust_ps_adjust_para_apds9110 = {
	.ps_up = 30,//60,
...
static struct alsps_hw cust_alsps_hw = {
	...
	.polling_mode_als =1,
    	...
    	.p_ps_adjust_para = &cust_ps_adjust_para_apds9110,
#ifdef VENDOR_EDIT
	//zhihong.lu@Prd.BSP.sensor,add for custom config
	.eint_gpio = 6,
	.als_gain1 = 20,
	.als_gain2 = 39,
	//zhihong.lu@Prd.BSP.sensor,2016/4/15,add for apds9922
...
struct alsps_hw *apds9110_get_cust_alsps_hw(void) {
    cust_alsps_hw.p_ps_adjust_para = &cust_ps_adjust_para_apds9110;
