...
/* bit 8 ~ bit 14 : Fuel Gauge 2.0 for OPPO
 * bit 15 : reserved bit
 */
#define RTC_NEW_SPARE1_OPPO_FG_MASK		0xff00
#define RTC_NEW_SPARE1_OPPO_FG_SHIFT		8
#endif /* VENDOR_EDIT */
...
#define RTC_SPAR0_REBOOT_KERNEL_BOOT		(1U << 8)
#define RTC_SPAR0_SILENCE_BOOT		(1U << 9)
#define RTC_SPAR0_MOS_BOOT		(1U << 10)
#endif
#ifdef VENDOR_EDIT
//mingqiang.guo@bsp.boot 2015/10/16, add for reboot meta
#define RTC_SPAR0_META_BOOT		(1U << 11)
//tong.han@bsp.Group.boot, add for reboot sau,2016/04/16
#define RTC_SPAR0_SAU_BOOT		(1U << 12)
#endif //VENDOR_EDIT
