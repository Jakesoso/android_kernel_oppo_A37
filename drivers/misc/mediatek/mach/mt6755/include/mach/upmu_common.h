...
#ifdef VENDOR_EDIT//Fanhong.Kong@ProDrv.CHG,modified 2016.2.26 for sim	reboot
...
extern void mt6351_upmu_set_isink_dim0_duty(int val);
extern void mt6351_upmu_set_isink_ch0_step(int val);
extern unsigned short mt6351_upmu_get_isink_dim0_duty(void);
extern unsigned short mt6351_upmu_get_isink_ch0_step(void);
#endif /* VENDOR_EDIT */
