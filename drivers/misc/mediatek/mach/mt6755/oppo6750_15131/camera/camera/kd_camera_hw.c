		       ...
		       char *mode_name)
{
	...
	BOOL sensorInPowerList = KAL_FALSE;
#ifdef VENDOR_EDIT
/*jindian.guan 2016/09/21 add for 16057 not use ov8865*/
...
/*jindian.guan 2016/09/21 add for 16057 not use ov8865*/
	...
	PK_DBG("kdCISModulePowerOn pcb_version =%d\n", pcb_version);
	if((strcmp(currSensorName,SENSOR_DRVNAME_OV8865_MIPI_RAW) == 0) && (pcb_version > HW_VERSION__12)){
	    PK_DBG("kdCISModulePowerOn not power on ov8865\n");
	    return 0;
	}
#endif
	/* power ON */
