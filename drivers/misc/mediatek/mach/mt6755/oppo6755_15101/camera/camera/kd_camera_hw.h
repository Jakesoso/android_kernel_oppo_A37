...
#define CAMERA_MAIN_AVDD_T0   (GPIO60 | 0x80000000)
#define CAMERA_MAIN_AVDD_M_GPIO     GPIO_MODE_00

#define CAMERA_MAIN_AVDD_EVT   (GPIO63 | 0x80000000)
...
#define CAMERA_SUB_AVDD   (GPIO82 | 0x80000000)
#define CAMERA_SUB_AVDD_M_GPIO     GPIO_MODE_00
