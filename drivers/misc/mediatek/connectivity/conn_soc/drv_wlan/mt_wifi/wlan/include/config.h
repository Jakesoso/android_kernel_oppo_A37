...
#ifndef VENDOR_EDIT
//HuangYuan@WCN.Wifi, 2016/06/22, Modify for enable 5G prefer feature
/*
#define CFG_SUPPORT_PREFER_5G			0
*/
#else /* VENDOR_EDIT */
#define CFG_SUPPORT_PREFER_5G			1
#endif /* VENDOR_EDIT */
...
/*------------------------------------------------------------------------------
 * Flags for special AP
 *------------------------------------------------------------------------------
 */
 
 #define CFG_SUPPORT_DETECT_ATHEROS_AP           1
