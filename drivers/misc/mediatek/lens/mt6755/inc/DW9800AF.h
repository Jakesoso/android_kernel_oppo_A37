...
#define DW9800AFIOC_G_MOTORINFO _IOR(DW9800AF_MAGIC, 0, stDW9800AF_MotorInfo)

#define DW9800AFIOC_T_MOVETO _IOW(DW9800AF_MAGIC, 1, u32)

#define DW9800AFIOC_T_SETINFPOS _IOW(DW9800AF_MAGIC, 2, u32)

#define DW9800AFIOC_T_SETMACROPOS _IOW(DW9800AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9800AFIOC_G_MOTORMETAINFO _IOR(DW9800AF_MAGIC, 4, stDW9800AF_MotorMETAInfo)
#endif
