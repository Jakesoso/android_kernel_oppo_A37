...
#define BMI160_USER_STEP_COUNTER_CONF_7A_ADDR			0x7A
#define BMI160_USER_STEP_COUNTER_CONF_7B_ADDR			0x7B
/* Step_conf desciption - reg Addr --> 0x7B, Bit --> 3*/
#define BMI160_USER_STEP_COUNTER_EN__POS			3
#define BMI160_USRE_STEP_COUNTER_EN__LEN			1
#define BMI160_USER_STEP_COUNTER_EN__MSK			0x08
#define BMI160_USER_STEP_COUNTER_EN__REG			BMI160_USER_STEP_COUNTER_CONF_7B_ADDR
		

#define BMI160_USER_STEP_COUNTER_DATA			0x78
#define BMI160_STEP_COUNTER_DATA_LEN			2
...
extern struct acc_hw* bmi160_get_cust_acc_hw(void);
#endif
