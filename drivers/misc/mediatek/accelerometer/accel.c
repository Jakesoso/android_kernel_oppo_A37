...
static int acc_set_polling_timer(bool enable){
	struct acc_context *cxt = NULL;
	cxt = acc_context_obj;
	//ACC_ERR("%d\n",enable);
	if (NULL == cxt->acc_ctl.open_report_data) {
