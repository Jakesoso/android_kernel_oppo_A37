...
#include "imx298semcomipiraw_Sensor.h"
...
extern void read_imx298semco_SPC( BYTE* data );
extern void read_imx298semco_DCC( kal_uint16 addr,BYTE* data, kal_uint32 size);

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX298SEMCO_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
kal_uint16 IMX298SEMCOMIPI_sensorGainMapping[IMX298MIPI_MaxGainIndex][2] ={	
	{64 ,1	},
	{65 ,8	},
	{66 ,16 },
	{67 ,25 },
...
static void imx298_apply_SPC(void)
{
	...
	{
		read_imx298semco_SPC(imx298_SPC_data);
		read_spc_flag = TRUE;
		return;
	}
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	{
		if(gain < IMX298SEMCOMIPI_sensorGainMapping[iI][0])
		{                
			return IMX298SEMCOMIPI_sensorGainMapping[iI][1];       
		}
	...
	if(iI != IMX298MIPI_MaxGainIndex)
	{
    	if(gain != IMX298SEMCOMIPI_sensorGainMapping[iI][0])
    	{
        	 LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX298SEMCOMIPI_sensorGainMapping[iI][0]);
    	}
    }
	LOG_INF("exit IMX298MIPIGain2Reg function\n");
    return IMX298SEMCOMIPI_sensorGainMapping[iI-1][1];
}
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			read_imx298semco_DCC((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
            break;
