...
extern CAMERA_FRONT_DEV camera_front_dev;
#endif
...
#ifdef VENDOR_EDIT
/*oppo hufeng 20151216 add for two version of 3p3*/
static kal_uint8 return_version_id(void)
{
    kal_uint8 versionIdL=0;
    char pu_send_cmd[2] = {(char)(0x0006>> 8), (char)(0x0006 & 0xFF) };

    iReadRegI2C(pu_send_cmd, 2, (u8*)&versionIdL, 1, 0xA2);
    return versionIdL;
}
#endif
/*************************************************************************
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint8 version_id = 0;//hufeng add for two version of 3p3
...
/*oppo hufeng 20151216 add for two version of 3p3*/
			...
			if (*sensor_id == 0x3103 && version_id == 0x37)
				*sensor_id = 0x8103;
#endif
			if (*sensor_id ==S5K3P3SX_SENSOR_ID) {
#ifdef VENDOR_EDIT
/*oppo hufeng 20150515 add for device list*/
            			camera_front_dev = CAMERA_BACK_S5K3P3SX;
#endif
