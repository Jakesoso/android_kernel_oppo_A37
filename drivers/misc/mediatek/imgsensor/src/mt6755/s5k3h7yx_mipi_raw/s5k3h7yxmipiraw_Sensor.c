...
#ifdef VENDOR_EDIT
/* Add by LiuBin for register device info at 20160616 */
static void register_deviceinfo_s5k3h7()
{
    ...
    module_id = read_cmos_sensor_8(0x0A08);
    LOG_INF("module_id = %d \n", module_id);
    register_imgsensor_deviceinfo("Cam_b", DEVICE_VERSION_S5K3H7, module_id);
}
#endif
