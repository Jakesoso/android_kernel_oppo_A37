...
//;mipi_datarate per lane: 840Mbps
		...
		write_cmos_sensor(0x5000, 0x13);//0x17
...
LOG_INF("o Read  module_integrator_id 0x%x, lens_id: 0x%x, rg_ratio: 0x%x, bg_ratio: 0x%x\n", 
...
{
int RG_Ratio_Typical = 0x123, BG_Ratio_Typical = 0x145;//Q-Tech
