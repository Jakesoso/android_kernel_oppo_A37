...
extern bool ov8865r_otp_update(void);
#endif

#define OV8865RLOG
#if define OV8865RLOG
...
#define DEVICE_VERSION_OV8865R		"ov8865r"
extern unsigned char get_module_id_ov8865r();
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	kal_uint16 OV8865R_GAIN_BASE = 128;


	reg_gain = gain*OV8865R_GAIN_BASE/BASEGAIN;
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	mirror= OV8865R_read_cmos_sensor(0x3820);
	flip  = OV8865R_read_cmos_sensor(0x3821);
            ...
            *sensor_id = *sensor_id + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {	
                ...
                if(deviceInfo_registered == false){
                     register_imgsensor_deviceinfo("Cam_b", DEVICE_VERSION_OV8865R, get_module_id_ov8865r());
...
UINT32 OV8865R_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV8865R_MIPI_RAW_SensorInit	*/
