...
void mt6351_upmu_set_isink_dim0_duty(int val)
{
  int ret=0;

  ret=pmic_set_register_value(MT6351_PMIC_ISINK_DIM0_DUTY, 0);
}

void mt6351_upmu_set_isink_ch0_step(int val)
{
  kal_uint32 ret=0;

  ret=pmic_set_register_value(MT6351_PMIC_ISINK_CH0_STEP, val);//8mA
}

unsigned short mt6351_upmu_get_isink_ch0_step(void) 
{

  unsigned short  val = 0;
  
  val = mt6351_get_register_value(MT6351_PMIC_ISINK_CH0_STEP);

  return val;
}

unsigned short mt6325_upmu_get_isink_dim0_duty(void)
{
  unsigned short  val = 0;
  
  val = mt6351_get_register_value(MT6351_PMIC_ISINK_DIM0_DUTY);
