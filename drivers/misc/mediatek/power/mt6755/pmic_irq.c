...
const char *pmic_interrupt_status_name[PMIC_INT_REG_NUMBER][PMIC_INT_WIDTH] = {
	...
	[1] = " RG_INT_STATUS_VGPU_OC",
	[2] = " RG_INT_STATUS_VSRAM_MD_OC",
	[3] = " RG_INT_STATUS_VMODEM_OC",
	[4] = " RG_INT_STATUS_VM1_OC",
	[5] = " RG_INT_STATUS_VS1_OC",
	[6] = " RG_INT_STATUS_VS2_OC",
	[7] = " RG_INT_STATUS_VPA_OC",
	[8] = " RG_INT_STATUS_VCORE_PREOC",
	[9] = " RG_INT_STATUS_VGPU_PREOC",
	[10] = " RG_INT_STATUS_VSRAM_MD_PREOC",
	[11] = " RG_INT_STATUS_VMODEM_PREOC",
	[12] = " RG_INT_STATUS_VM1_PREOC",
	[13] = " RG_INT_STATUS_VS1_PREOC",
	[14] = " RG_INT_STATUS_VS2_PREOC",
	[15] = " RG_INT_STATUS_LDO_OC",
	},
	{
	[0] = " RG_INT_STATUS_JEITA_HOT",
	[1] = " RG_INT_STATUS_JEITA_WARM",
	[2] = " RG_INT_STATUS_JEITA_COOL",
	[3] = " RG_INT_STATUS_JEITA_COLD",
...
void chrdet_int_handler(void)
{
	...
	if (!upmu_get_rgs_chrdet()) {
		...
		if (boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT
			...
			#ifndef VENDOR_EDIT//Fanhong.Kong@ProDrv.CHG, delete 2014.12.5 for fastchg
            mt_power_off();
			#endif/*VENDOR_EDIT*/
		}
	}
