...
#ifdef VENDOR_EDIT
/*huacai.zhou@PSW.BSP.Kernel.MM 2018-10-31, add aggressive lowmemkiller support for lowmem devices*/
...
#ifdef VENDOR_EDIT
/*yixue.ge@PSW.BSP.Kernel.Driver 20170808 modify for get some data about performance */
unsigned long lowmem_kill_count = 0;
...
#if defined(VENDOR_EDIT) && defined(CONFIG_SWAP)
/*huacai.zhou@PSW.BSP.Kernel.MM 2018-10-31, show aggressive lmk and swap info*/
...
#ifdef VENDOR_EDIT
/*huacai.zhou@PSW.BSP.Kernel.MM 2018-10-31 add aggrgessive lmk support*/
