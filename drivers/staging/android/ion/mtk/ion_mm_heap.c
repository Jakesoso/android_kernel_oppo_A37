...
static int ion_mm_heap_debug_show(struct ion_heap *heap, struct seq_file *s, void *unused)
{
	...
	int i;
#ifdef VENDOR_EDIT
//Runsheng.Pei@Swdp.Android.Performance.Memory, 2014.09.30, add to show total size for calculate the free memory
...
#ifdef VENDOR_EDIT
//Runsheng.Pei@Swdp.Android.Performance.Memory, 2014.09.30, add to show total size for calculate the free memory
    ION_PRINT_LOG_OR_SEQ(s, "total_bytes_in_uncached_pool: %lu; total_bytes_in_cached_pool: %lu\n",
            total_bytes_in_uncached_pool, total_bytes_in_cached_pool);

    ION_PRINT_LOG_OR_SEQ(s, "Total bytes in pool: %lu\n", (total_bytes_in_uncached_pool + total_bytes_in_cached_pool));
#endif /* VENDOR_EDIT */
